...
- [1. Cours le matin - 10h-12h](#1-cours-le-matin---10h-12h)
  - [1.1. Livres](#11-livres)
  - [1.2. Sites](#12-sites)
  - [1.3. Plateformes de données](#13-plateformes-de-données)
  - [1.4. Définitions de la carte, des types de cartes](#14-définitions-de-la-carte-des-types-de-cartes)
  - [1.5. Exemple de plan d'un cours complet](#15-exemple-de-plan-dun-cours-complet)
  - [1.6. Le succédané de cours en 2H](#16-le-succédané-de-cours-en-2h)
- [2. TD l'après-midi : 14h-17h](#2-td-laprès-midi--14h-17h)
  ...
  - [2.2. Cartographier le traffic maritime en 1789](#22-cartographier-le-traffic-maritime-en-1789)
    - [2.2.1. La localisation géographique des origines-destinations : ports](#221-la-localisation-géographique-des-origines-destinations--ports)
    - [2.2.2. La matrice origine-destination](#222-la-matrice-origine-destination)
...
- Lambert N., Zanin C., 2016, Manuel de cartographie. Principes, méthodes, applications, Paris, Armand Colin, 221 p.
- Le Fur A.,2011, Pratiques de la cartographie, Paris, Armand Colin, 127 p.
- Béguin M., Pumain D., 2017, La représentation des données géographiques. Statistique et cartographie, 4e ed., Paris, Colin, 264 p.

Pour la statistique  :

- Dumolard P., Dubus N., Charleux L., 2003, Les statistiques en géographie, Paris, Belin, 240 p.
- Droesbeke J.-J., Lejeune M., Saporta G., 2006, Analyse statistique des données spatiales, Paris, Technip, 468 p.
...
- La banque mondiale : http://databank.banquemondiale.org/data/
-	En France, l'insee : www.insee.fr  
-	En Europe, Eurostat https://ec.europa.eu/eurostat/fr/data/database et GISCO https://ec.europa.eu/eurostat/fr/web/gisco/geodata/reference-data/administrative-units-statistical-units 

## 1.4. Définitions de la carte, des types de cartes
...
## 1.5. Exemple de plan d'un cours complet

L’INFORMATION GÉOGRAPHIQUE ET SON ANALYSE

- 1.1. Le fond de carte
- 1.2. Les données attributaires
- 1.3. Les sources de l’information géographique et statistique
...
## 1.6. Le succédané de cours en 2H
...
### 2.2.1. La localisation géographique des origines-destinations : ports
...
### 2.2.2. La matrice origine-destination 
...
J'ai filtré cette matrice avec un petit programme python pour faire des analyses des départs depuis Dunkerque. 
...
<img src="./python/sankey_export_product_Dunkerque_1789.png" height=1000 alt="Diagramme alluvial">
